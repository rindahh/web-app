...
st.latex('H_{0} : \mu = \mu_{0}') #untuk memunculkan tulisan matematis
st.latex('H_{1} : \mu \neq \mu_{0}')
...
if clicked:
    ...
    st.write(f'titik kritis = {alpha_z}, hitung z = {z_score}, p_value = {p_value}') #memakai kurung kurawa {} karena untuk mengambil dan menampilkan hasil dari perthitungan data yang ada
